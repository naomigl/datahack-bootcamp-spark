package com.datahack.bootcamp.spark.exercises.flights.model.spark.streaming

import com.datahack.bootcamp.spark.exercises.flights.model.{AirportStatistics, Flight, FlightTicket}
